...
This file contains the full implementation for loading PDFs and searching
"""
...
class KnowledgeBase:
    ...
    def load_pdf_document(self, file_path: str, file_id: str) -> Optional[Dict]:
        ...
        try:
            ...
            category = "general"
            if "return" in file_id.lower():
                category = "returns"
            elif "shipping" in file_id.lower():
                category = "shipping"
            elif "password" in file_id.lower() or "account" in file_id.lower():
                category = "account"
            elif "troubleshoot" in file_id.lower():
                category = "troubleshooting"
            elif "payment" in file_id.lower():
                category = "payment"
            elif "support" in file_id.lower():
                category = "support"
            ...
            logger.info(f"Successfully loaded {file_id}: {len(text)} characters, category: {category}")
            return document
    ...
    def load_documents(self):
        ...
        # Check if PDF directory exists, if not use sample data
        ...
        logger.info(f"Loaded {len(self.documents)} documents in {load_time:.2f} seconds")
    ...
    def get_statistics(self) -> Dict:
        ...
        for doc in self.documents:
            ...
            stats["total_characters"] += len(doc["text"])
...
if __name__ == "__main__":
    ...
    # Test search
    test_query = "How can I return a product?"
